...
export default function FirstStorySection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full max-w-full bg-[#1e1e1e] text-white relative lg:overflow-hidden"
    >
      {/* Green Curve Overlay */}
      <div className="absolute  lg:top-[10rem] top-[25rem]  -left-44 lg:left-10 hidden lg:block md:overflow-hidden w-full h-full pointer-events-none z-[30]">
        <svg
          ...
          className="jsx-331386f03080d6ed w-full min-w-[200vw] md:min-w-[150vw] lg:min-w-full h-auto"
        >
          <path
            ref={svgPathRef}
            ...
            fill="none"
            className="jsx-331386f03080d6ed"
          ></path>
        </svg>
      </div>
      <div
        ref={cardRef}
        className="mx-auto bg-[#e8e8e7] px-4 pb-20 pt-14 sm:px-8 md:px-10"
        style={{
      ...
      >
        ...
        <div
          ref={imageWrapRef}
          className="relative mt-12 overflow-hidden rounded-none bg-black mx-auto"
        >
          {/* Image */}
          <img
        ...
        <div className="mt-[5%] w-[97%] mx-auto grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-14">
          ...
          <div className="max-w-xl">
            <h3 className="text-3xl font-medium leading-tight text-black/80 tracking-tight sm:text-4xl md:text-5xl">
              Driving measurable growth and engagement through high-performing
              digital experiences.
            </h3>
          </div>
