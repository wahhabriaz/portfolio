...
const svgPathRef = useRef<SVGPathElement | null>(null);
  ...
  return (
    <section ref={sectionRef} className="w-full max-w-full bg-[#1e1e1e] text-white relative">
        {/* Green Curve Overlay */}
      ...
      <div ref={cardRef} className="mx-auto bg-[#e8e8e7] px-4 pb-20 pt-14 sm:px-8 md:px-10"  style={{
        ...
        <div ref={imageWrapRef} className="relative mt-12 overflow-hidden rounded-none bg-black mx-auto">
          {/* Image */}
          <img
            src="/images/portrait.jpg" // 🔁 replace with your image path
            alt="Portrait"
            className="h-[320px] w-full object-cover sm:h-[420px] md:h-[520px] lg:h-[600px] will-change-transform"
